...
const domToPptxDir = dirname(require.resolve('dom-to-pptx/package.json'));
const bundlePath = join(domToPptxDir, 'dist/dom-to-pptx.bundle.js');
if (!existsSync(bundlePath)) {
  console.error('dom-to-pptx bundle not found. Run: npm install -g dom-to-pptx');
  process.exit(1);
}
